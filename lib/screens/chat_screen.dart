...
class _ChatScreenState extends ConsumerState<ChatScreen> {
  ...
  void initState() {
    ...
    messages.add({
      "text":
          "Soy KAY/O 🤖\nPregúntame por ofertas, recomendaciones, niveles, envios o algun error ocurrido en la app.",
      "isUser": false
    });
  }
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      FocusScope.of(context).unfocus(); // Cierra teclado al enviar

                      if (botData.hasValue) {
                        final reply = _matchReply(
                          text.toLowerCase(),
                          botData.value!,
                        );
                        setState(() {
  ...
  String _matchReply(String input, List<BotMessage> list) {
    ...
    return "No entendí bien, pero puedo ayudarte con ofertas, recomendaciones, niveles, envios o algun error ocurrido en la app.";
  }
}
